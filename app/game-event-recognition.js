(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '@media(max-width:1120px){.game-event-recognition-layout{grid-template-columns:minmax(0,1fr)}.game-event-recognition-settings{grid-template-columns:repeat(2,minmax(0,1fr))}.game-event-recognition-toggle,.game-event-recognition-help{grid-column:1/-1}}',
